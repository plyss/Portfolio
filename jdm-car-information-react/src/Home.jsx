...
export default function Home() {
	...
	const getNewestCars = async () => {
		const res = await axios.get('https://heroic-panda-552f6c.netlify.app/.netlify/functions/api/cars?_sort=year&_order=desc')
		setNewestCars(res.data)
	}

	const getLatestArrivals = async () => {
		const res = await axios.get('https://heroic-panda-552f6c.netlify.app/.netlify/functions/api/cars?_sort=id&_order=desc')
